...
local skillConfig = {
  elites = {
    {
      self_repair_attack_percent = 1.03,
    },
    {
      tactical_synergy_attack_speed = 1.1,
      self_repair_attack_percent = 1.05,
    },
    {
      tactical_synergy_attack_speed = 1.2,
      self_repair_attack_percent = 1.15,
    },
  },
  skills = { {
    id = "skill1",
    ...
    levels = { {
      ...
      ingredients = { Ingredient("ark_item_mtl_skill1", 5) }
    }, {
      activationEnergy = 5,
      desc = STRINGS.UI.MON3TR_SKILL.LEVEL_DESC[1][3],
      config = { healRate = 1.25, healChainCount = 4 },
      ingredients = { Ingredient("ark_item_mtl_skill1", 5), Ingredient("ark_item_mtl_sl_boss1", 4), Ingredient("ark_item_mtl_sl_rush1", 4) }
    }, {
      activationEnergy = 5,
      desc = STRINGS.UI.MON3TR_SKILL.LEVEL_DESC[1][4],
      config = { healRate = 1.35, healChainCount = 4 },
      ingredients = { Ingredient("ark_item_mtl_skill2", 8), Ingredient("ark_item_mtl_sl_g2", 7) }
    }, {
      activationEnergy = 5,
      desc = STRINGS.UI.MON3TR_SKILL.LEVEL_DESC[1][5],
      config = { healRate = 1.5, healChainCount = 4 },
      ingredients = { Ingredient("ark_item_mtl_skill1", 8), Ingredient("ark_item_mtl_sl_strg2", 4), Ingredient("ark_item_mtl_sl_ketone2", 4) }
    }, {
      activationEnergy = 5,
      desc = STRINGS.UI.MON3TR_SKILL.LEVEL_DESC[1][6],
      config = { healRate = 1.6, healChainCount = 4 },
      ingredients = { Ingredient("ark_item_mtl_skill2", 8), Ingredient("ark_item_mtl_sl_strg3", 7) }
    }, {
      activationEnergy = 3,
      desc = STRINGS.UI.MON3TR_SKILL.LEVEL_DESC[1][7],
      config = { healRate = 1.7, healChainCount = 4 },
      ingredients = { Ingredient("ark_item_mtl_skill3", 8), Ingredient("ark_item_mtl_sl_ccf", 5), Ingredient("ark_item_mtl_sl_rush3", 3) }
    }, {
      activationEnergy = 3,
      desc = STRINGS.UI.MON3TR_SKILL.LEVEL_DESC[1][8],
      config = { healRate = 1.8, healChainCount = 4 },
      ingredients = { Ingredient("ark_item_mtl_skill3", 8), Ingredient("ark_item_mtl_sl_zyk", 4), Ingredient("ark_item_mtl_sl_g3", 10) }
    }, {
      activationEnergy = 3,
      desc = STRINGS.UI.MON3TR_SKILL.LEVEL_DESC[1][9],
      config = { healRate = 1.9, healChainCount = 4 },
      ingredients = { Ingredient("ark_item_mtl_skill3", 12), Ingredient("ark_item_mtl_sl_htt", 4), Ingredient("ark_item_mtl_sl_pgel4", 9) }
    }, {
      activationEnergy = 2,
      desc = STRINGS.UI.MON3TR_SKILL.LEVEL_DESC[1][10],
      config = { healRate = 2.0, healChainCount = 4 },
      ingredients = { Ingredient("ark_item_mtl_skill3", 15), Ingredient("ark_item_mtl_sl_ds", 6), Ingredient("ark_item_mtl_sl_pg2", 6) }
    }, }
  }, {
    id = "skill2",
    ...
    levels = { {
      ...
      activationEnergy = 15,
      buffDuration = 25,
      desc = STRINGS.UI.MON3TR_SKILL.LEVEL_DESC[3][10],
      config = { healChainCount = 3 }
    }, }
  } }
}
