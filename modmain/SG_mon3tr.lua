...
AddStategraphPostInit("wilson", function(sg)
    ...
    sg.states["attack"].onenter = function(inst, ...)
      ...
      if inst.prefab == "mon3tr" and inst.components.ark_skill and inst.components.ark_skill:GetSkill("skill3"):IsActivating() then
...
AddStategraphState("wilson", State{
    ...
    timeline = {
        ...
        TimeEvent(2 * FRAMES, function(inst)
            ...
            inst.components.colouradder:PushColour("superjump", SUPERJUMP_COLOR_R * .9, SUPERJUMP_COLOR_G * .9, SUPERJUMP_COLOR_B * .9, 0)
        end),
...
AddStategraphState("wilson", State{
    ...
    timeline = {
        ...
        TimeEvent(2 * FRAMES, function(inst)
            ...
            inst.components.colouradder:PushColour("superjump", SUPERJUMP_COLOR_R * .95, SUPERJUMP_COLOR_G * .95, SUPERJUMP_COLOR_B * .95, 0)
        end),
        TimeEvent(3 * FRAMES, function(inst)
            inst.AnimState:SetMultColour(1,1,1,1)
            inst.components.colouradder:PushColour("superjump", SUPERJUMP_COLOR_R * .9, SUPERJUMP_COLOR_G * .9, SUPERJUMP_COLOR_B * .9, 0)
        ...
        TimeEvent(4 * FRAMES, function(inst)
            inst.components.colouradder:PushColour("superjump", SUPERJUMP_COLOR_R * .85, SUPERJUMP_COLOR_G * .85, SUPERJUMP_COLOR_B * .85, 0)
